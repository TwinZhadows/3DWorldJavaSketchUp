 ...
 * @author chon
 */
public class Collision3 implements AnimationListener{
...
*/
       ...
       //generate movement steps
        ...
        Point2f dest = new Point2f(100, 20); 
        float rotation = 90;
        double dAngle = 90;
        int step = 10;
      
        movStep = new MovementWrapper().genStepsArray(terrain, start, dest, 0, 0, 0, 10);
        movStep2 = new MovementWrapper().genStepsArray(terrain, new Point2f(100, 10), new Point2f(100, 170), 0, 0, 0, 10);
        movStep3 = new MovementWrapper().genStepsArray(terrain, new Point2f(100, 170), new Point2f(100, 170), 0, 90, 10, 11);
       
        //add user model
        UserWrapper user = new UserWrapper("car.skp", new Point2f(100, 150), 0,(float)0.2, 270);
        ...
        Model car = new Model ("car","car.skp", new Point2f(100,10), 0,(float) 0.2, 90, true); 
        
        terrain.addModel(car);
        car.setAnimation(movStep2);
        car.setAnimation(movStep3);
        car.loadAnimation();
        models.add(car);

        
        Model car2 = new Model ("car2","car.skp", new Point2f(50,20),0, (float) 0.2, 90, true); 
        
        //terrain.addModel(car2);
        //car2.setAnimation(movStep3, false);
        //car2.loadAnimation();
        //models.add(car2);
        
        terrain.setListener(new Collision3());
