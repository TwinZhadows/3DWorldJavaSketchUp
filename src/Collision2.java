 ...
 * @author chon
 */
public class Collision2 implements AnimationListener{
    ...
    public static void main(String args[]) throws IOException, MovementException {
        ...
        try {
            terrain = new TerrainConstructor("C:/Users/Roonnapak/Documents/NetBeansProjects/terrain2/height64.png", 50, plgSize);
     ...
     //texture the terrain
        ...
        terrain.setTexture(1, grass,25);
        terrain.setTexture(2, sand, 25);
        terrain.setTexture(3, darkSand, 50);
        terrain.texture();
...
*/
       ...
       //generate movement steps
        ...
        //add user model
        UserWrapper user = new UserWrapper("car.skp", new Point2f(20, 20), 30, (float)0.2, 45);
        ...
        Model car = new Model ("car.skp", new Point2f(100,100), 30, (float) 0.2, 225, true); 
       ...
       //terrain.setListener((AnimationListener) new Collision2());
