...
public class City {
    ...
    public static void main(String args[]) throws IOException, MovementException {
        ...
        */
        ...
        terrain = new TerrainConstructor( 3, 25, 0);   
 ...
 /*       
        ...
        */
      //  Model car = new Model ("car","car2.skp", new Point2f(170,175), 0,(float) 0.6, -90, true);
      //  Model car2 = new Model ("car","car2.skp", new Point2f(190,175), 0,(float) 0.6, -90, true);
       ...
       // terrain.addModel(car2);
        ...
        models.add(car);
        models.add(car2);
        UserWrapper user = new UserWrapper("car.skp", new Point2f(175, 30), 0,(float)0.2, 90);
